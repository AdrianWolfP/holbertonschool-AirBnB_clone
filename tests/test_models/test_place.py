...
# Get the parent directory of the current script (test_place.py, test_review.py, or test_user.py)
current_dir = os.path.dirname(os.path.abspath(__file__))

# Get the parent directory of the current directory (the directory containing test_place.py, test_review.py, and test_user.py)
